      ...
      return (
        <div
          style={{
            ...
            padding: "2rem",
            textAlign: "center",
            backgroundColor: "var(--color-error-page-bg)",
        ...
        >
          ...
          <p style={{ color: "var(--color-error-page-secondary)", marginBottom: "1.5rem", maxWidth: "400px" }}>
          ...
          <button
            ...
            style={{
              ...
              borderRadius: "0.5rem",
              border: "none",
              backgroundColor: "var(--color-error-page-button-bg)",
          ...
          {this.state.error && (
            <pre
              style={{
                marginTop: "2rem",
                padding: "1rem",
                background: "var(--color-error-page-code-bg)",
                borderRadius: "0.5rem",
                fontSize: "0.75rem",
                color: "var(--color-error-page-code-text)",
                maxWidth: "600px",
                overflow: "auto",
                textAlign: "left",
              }}
