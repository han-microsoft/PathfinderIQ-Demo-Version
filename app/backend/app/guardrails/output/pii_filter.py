...
expected in network operations telemetry output and are not PII in this
domain.

Pattern list is configurable per-instance to support domain-specific
tuning via scenario.yaml guardrail configuration.
...
# Default PII patterns — intentionally excludes IPv4 (expected in network ops)
